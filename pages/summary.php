...
<html lang="en">
  ...
  >
    ...
    <main class="lg:ml-64">
      <!-- Header -->
      <header
        class="bg-white/80 backdrop-blur-lg shadow-sm sticky top-0 z-30 border-b border-gray-100 mb-3"
      >
        <div class="px-6 py-4 flex items-center justify-between">
          <div class="animate-fade-up">
            <h1 class="text-2xl font-bold text-gray-800">Summary Dashboard</h1>
            <p class="text-sm text-gray-500 mt-1">
              Comprehensive overview of device management system
            </p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div class="stat-card bg-white p-6 rounded-2xl shadow-sm">
            <div class="flex items-center justify-between mb-4">
              ...
              <span
                class="text-sm font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-lg"
                >Devices</span
              >
            </div>
          ...
          <div class="stat-card bg-white p-6 rounded-2xl shadow-sm">
            <div class="flex items-center justify-between mb-4">
              ...
              <span
                class="text-sm font-medium text-green-600 bg-green-50 px-2 py-1 rounded-lg"
                >Active</span
              >
            </div>
          ...
          <div class="stat-card bg-white p-6 rounded-2xl shadow-sm">
            <div class="flex items-center justify-between mb-4">
              ...
              <span
                class="text-sm font-medium text-purple-600 bg-purple-50 px-2 py-1 rounded-lg"
                >Users</span
              >
            </div>
            ...
            <table class="min-w-full">
              ...
              <tbody class="divide-y divide-gray-100">
                <tr class="table-row">
                  ...
                  <td class="px-6 py-4">
                    <span
                      class="px-2 py-1 text-xs font-medium bg-green-50 text-green-600 rounded-lg"
                      >Completed</span
                    >
                  </td>
                </tr>
