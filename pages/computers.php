        ...
        <div class="px-6 py-4 flex items-center justify-between">
          <div class="animate-fade-up">
            ...
            <p class="text-sm text-gray-500 mt-1">
              Manage and track all computer devices
            </p>
          </div>
                ...
                <tr class="table-row">
                  ...
                  <td class="px-6 py-4">
                    <div class="text-sm space-y-1">
                      <div class="flex items-center">
                        <i
                          class="fas fa-microchip text-gray-400 text-xs mr-2 w-4"
                        ></i>
                        <span class="text-gray-700">Intel i7-12700</span>
                      </div>
                      <div class="flex items-center">
                        <i
                          class="fas fa-memory text-gray-400 text-xs mr-2 w-4"
                        ></i>
                        <span class="text-gray-700">16GB DDR4</span>
                      </div>
                      <div class="flex items-center">
                        <i
                          class="fas fa-hdd text-gray-400 text-xs mr-2 w-4"
                        ></i>
                  ...
                  <td class="px-6 py-4">
                    <div class="text-sm space-y-1">
                      <div class="flex items-center">
                        <i
                          class="fas fa-network-wired text-gray-400 text-xs mr-2"
                        ></i>
          ...
          <form id="addComputerForm" class="space-y-6">
            ...
            <div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2"
                    >System Unit Serial Number</label
                  >
                  <input
                    type="text"
