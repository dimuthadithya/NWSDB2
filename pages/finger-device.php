      ...
      <nav class="p-4">
        <div class="space-y-1">
          ...
          >
            ...
            <span class="font-medium">Finger Devices</span>
          </a>
          <a
            href="#"
            class="sidebar-link flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-gray-50"
        ...
        <div class="px-6 py-4 flex items-center justify-between">
          <div class="animate-fade-up">
            <h1 class="text-2xl font-bold text-gray-800">
              Finger Device Management
            </h1>
            <p class="text-sm text-gray-500 mt-1">
              Manage and track all biometric finger devices
            </p>
          </div>
      ...
      >
        ...
        <form class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2"
                >Identification Code (Serial No)</label
              >
              <input
                type="text"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
