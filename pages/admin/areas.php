...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div
          ...
          <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-sm bg-white/20 px-3 py-1 rounded-full">Schemes</span>
          </div>
  ...
  <div
    ...
    <div
      ...
      <form id="addAreaForm" method="POST" action="handlers/area-handler.php" class="p-6">
      ...
      <form id="deleteAreaForm" method="POST" action="handlers/area-handler.php" class="p-6">
        ...
        <div class="mb-6">
          ...
          <p class="text-sm text-red-600 mt-2">
            ...
            This action cannot be undone. All associated water supply schemes will be affected.
          </p>
        </div>
  ...
  <script>
    ...
    function openEditModal(area) {
      ...
      document.getElementById('edit_region_id').value = area.region_id;
    ...
    function confirmDelete(areaId, areaName) {
      document.getElementById('delete_area_id').value = areaId;
