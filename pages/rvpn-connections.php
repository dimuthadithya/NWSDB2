      ...
      <nav class="p-4">
        <div class="space-y-1">
          ...
          >
            ...
            <span class="font-medium">RVPN Connections</span>
          </a>
          <a
        ...
        <div class="px-6 py-4 flex items-center justify-between">
          <div class="animate-fade-up">
            <h1 class="text-2xl font-bold text-gray-800">
              RVPN Connection Management
            </h1>
            <p class="text-sm text-gray-500 mt-1">
              Manage and track all RVPN connections
            </p>
          </div>
      ...
      >
        ...
        <form class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2"
                >Serial Number of RVPN Connection</label
              >
              <input
                type="text"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2"
                >Username of RVPN Connection</label
              >
              <input
                type="text"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="md:col-span-2">
              <label class="block text-sm font-medium text-gray-700 mb-2"
                >Whether the connection is required or not</label
              >
              <select
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
