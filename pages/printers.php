    ...
    >
      ...
      <nav class="p-4">
        <div class="space-y-1">
          ...
          <a
            href="./printers.html"
            class="bg-blue-50 text-blue-600 sidebar-link flex items-center space-x-3 px-4 py-3 rounded-xl"
          >
      ...
      >
        <div class="px-6 py-4 flex items-center justify-between">
          <div class="animate-fade-up">
            <h1 class="text-2xl font-bold text-gray-800">Printer Management</h1>
            <p class="text-sm text-gray-500 mt-1">
              Manage and track all Printer devices
            </p>
          </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2"
                  ><i class="fas fa-print text-blue-600 mr-2"></i>Printer
                  Type</label
                >
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-2"
                  ><i class="fas fa-circle-dot text-blue-600 mr-2"></i
                  >Status</label
                >
                  ...
                  <td class="px-6 py-4">
                    <div class="text-sm space-y-1">
                      <div class="flex items-center">
                        ...
                        ><span class="text-gray-700">Type: Laser</span>
                      </div>
                      <div class="flex items-center">
                        <i
                          class="fas fa-palette text-gray-400 text-xs mr-2 w-4"
                        ></i
                        ><span class="text-gray-700">Color: Monochrome</span>
                      </div>
                      <div class="flex items-center">
                        <i
                          class="fas fa-file-alt text-gray-400 text-xs mr-2 w-4"
                        ></i
                        ><span class="text-gray-700">Paper: A4, Letter</span>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4">
